            ...
            <div class="md:col-span-4 flex flex-col">
                <div class="mb-6 flex flex-col items-center md:items-start text-center md:text-left">
                    ...
                    <div class="social-links flex space-x-4 mb-6">
                        <a href="#" class="bg-blue-800/50 hover:bg-lm-yellow w-10 h-10 rounded-full flex items-center justify-center transform hover:scale-110 transition duration-300 hover:text-blue-900 shadow-lg" aria-label="Facebook">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                                <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                            </svg>
                        </a>
                        <a href="#" class="bg-blue-800/50 hover:bg-lm-yellow w-10 h-10 rounded-full flex items-center justify-center transform hover:scale-110 transition duration-300 hover:text-blue-900 shadow-lg" aria-label="Instagram">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                        ...
                        <a href="#" class="bg-blue-800/50 hover:bg-lm-yellow w-10 h-10 rounded-full flex items-center justify-center transform hover:scale-110 transition duration-300 hover:text-blue-900 shadow-lg" aria-label="LinkedIn">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" viewBox="0 0 16 16">
                ...
                <!-- Newsletter -->
                <div class="bg-blue-800/50 backdrop-blur-sm rounded-xl p-5 shadow-lg border border-blue-700/30 transform transition duration-300 hover:shadow-blue-500/10">
                    <h4 class="text-base font-bold mb-3 text-lm-yellow flex items-center">
                    ...
                    <form class="flex flex-col sm:flex-row gap-2">
                        <input type="email" placeholder="Your email" class="px-4 py-2 bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-lm-yellow focus:border-transparent w-full text-sm text-white placeholder-white/60" required>
                        <button type="submit" class="bg-lm-yellow hover:bg-lm-yellow-light text-blue-900 font-medium py-2 px-4 rounded-lg transition duration-300 transform hover:-translate-y-1 hover:shadow-lg text-sm whitespace-nowrap">
                            Subscribe
                        </button>
                    </form>
                </div>
